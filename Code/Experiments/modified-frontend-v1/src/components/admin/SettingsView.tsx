        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className="w-full md:w-64 rounded-lg border border-slate-300 py-2.5 px-3 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white">
                <option>4</option>
                <option>6</option>
                <option>8</option>
                <option>10</option>
            ...
            <div>
              ...
              <input type="number" defaultValue={24} className="w-full md:w-64 rounded-lg border border-slate-300 py-2.5 px-3 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" />
            </div>
          </div>
        </div>

        <div className="pt-4">
          <button type="button" className="px-5 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 shadow-sm transition-colors">
            Save Settings
          </button>
        </div>
      </div>
