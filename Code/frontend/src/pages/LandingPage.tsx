      ...
      <nav className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex md:items-center md:gap-8">
            ...
            <a href="#workflow" className="text-sm font-medium text-slate-600 hover:text-blue-600 transition-colors">How it Works</a>
            <a href="#admin" className="text-sm font-medium text-slate-600 hover:text-blue-600 transition-colors">Admin Portal</a>
          </div>

          <div className="hidden md:flex md:items-center md:gap-4">
            <Link to="/login" className="text-sm font-medium text-slate-600 hover:text-blue-600 transition-colors">Log in</Link>
            <Link to="/register" className="rounded-full bg-blue-600 px-5 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-blue-700 transition-all hover:shadow-md active:scale-95">
              Create Account
            </Link>
          </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-4">
              ...
              <Link to="/register" className="w-full rounded-full bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white">
                Create Account
              </Link>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden pt-16 pb-24 lg:pt-32 lg:pb-40">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              The modern way to manage <span className="text-blue-600">train travel</span>.
            </h1>
            <p 
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
              <div className="relative lg:col-span-1">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="City or Station" className="w-full rounded-lg border border-slate-200 py-3 pl-10 pr-4 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                </div>
              </div>
              <div className="relative lg:col-span-1">
              ...
              <div className="relative lg:col-span-1">
                ...
                <div className="relative">
                  ...
                  <input type="date" className="w-full rounded-lg border border-slate-200 py-3 pl-10 pr-4 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 text-slate-600" />
                </div>
              </div>
              <div className="relative lg:col-span-1">
                ...
                <div className="relative">
                  ...
                  <select className="w-full rounded-lg border border-slate-200 py-3 pl-10 pr-4 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 bg-white appearance-none">
              ...
              <div className="lg:col-span-1 flex items-end">
                <Link to="/login" className="w-full rounded-lg bg-blue-600 py-3 px-4 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 h-[46px]">
      ...
      <section id="features" className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-blue-600 font-semibold tracking-wide uppercase text-sm">For Passengers</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={i}
                className="rounded-2xl border border-slate-100 bg-slate-50/50 p-8 hover:shadow-lg hover:border-blue-100 transition-all"
              >
      ...
      <section id="workflow" className="py-24 bg-slate-900 text-white overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-blue-400 font-semibold tracking-wide uppercase text-sm">The Workflow</h2>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="flex-shrink-0 flex flex-col items-center">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500/20 text-blue-400 font-mono text-sm font-bold border border-blue-500/30">
                        {item.step}
                      </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center bg-slate-900/50 p-3 rounded-lg border border-slate-700/50">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-medium text-blue-400">First Class</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700/50 mt-4">
                    ...
                    <div className="flex justify-between font-semibold border-t border-slate-700 pt-3">
                      <span>Total</span>
                      <span className="text-blue-400">$132.50</span>
                    </div>
                  </div>

                  <button className="w-full rounded-lg bg-blue-500 py-3 text-sm font-semibold text-white hover:bg-blue-600 transition-colors flex items-center justify-center gap-2">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="rounded-2xl bg-white p-6 shadow-sm border border-slate-200">
                    <Settings className="h-6 w-6 text-blue-600 mb-4" />
                  ...
                  <div className="rounded-2xl bg-blue-600 p-6 shadow-sm text-white">
                    <ShieldCheck className="h-6 w-6 text-blue-200 mb-4" />
                    <h4 className="font-semibold">Secure Access</h4>
                    <p className="text-sm text-blue-100 mt-1">Role-based access control for administrative staff.</p>
                  </div>
                </div>
            ...
            <div className="flex-1 order-1 md:order-2">
              <h2 className="text-blue-600 font-semibold tracking-wide uppercase text-sm">Admin Portal</h2>
              ...
              <Link to="/admin/login" className="mt-8 inline-flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-700 transition-colors">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/register" className="w-full sm:w-auto rounded-full bg-blue-600 px-8 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition-all hover:shadow-md active:scale-95 text-center">
