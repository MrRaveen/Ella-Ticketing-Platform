...
> Note: Please adjust these to match the exact stack used in your `/Code` directory.
...
Ensure you have the following installed on your operating system (e.g., Fedora Linux):
* Git
